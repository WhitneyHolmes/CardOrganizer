/**
 * Adds a new First Job card to the playing deck
 * @author Whitney Holmes
 */
public class FirstJobCard extends Card {
    
    //An empty array of length 99 998
    static FirstJobCard[] playingDeck = new FirstJobCard[MAXLENGTH];
    //Companion variable for the array
    static int numCards = 0;

    private final int SETNUM = 200000;

    /**
     * Constructor method for a First Job card
     ...
     */
    public FirstJobCard(int codeIn, String nameIn, String descriptionIn) {
    ...
    public String DisplayCurrentCards(int codeIn ) {
        ...
        String display = "First Job Card:\n";

        if(playingDeck[codeIn - SETNUM] != null) {
            FirstJobCard currentCard = playingDeck[codeIn - SETNUM];
